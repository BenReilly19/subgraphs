  ...
  while (toDate(compChart[key1][stitchLeftIndex][timeKey]) !== toDate(compChart[key2][stitchLeftIndex][timeKey])) {
    if (compChart[key1][stitchLeftIndex][timeKey] < compChart[key2][stitchLeftIndex][timeKey]) {
      ...
      if (stitchLeftIndex > 0) {
        newArray = [
          ...compChart[key1].slice(0, stitchLeftIndex),
          ...compChart[key1].slice(startIndex, compChart[key1].length),
        ];
      }
      ...
      if (stitchLeftIndex > 0) {
        newArray = [
          ...compChart[key2].slice(0, stitchLeftIndex),
          ...compChart[key2].slice(startIndex, compChart[key2].length),
        ];
      }
